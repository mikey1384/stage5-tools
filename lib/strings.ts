export const strings = {
  en: {
    ...
    aboutSubtitle:
      "Stage5 Tools builds Translator, an AI-powered video translation and subtitle editing app designed for modern creators, educators, and global teams.",
    aboutMission: "Our mission",
    aboutMissionDesc:
      "Make it effortless to translate video content, learn from global media, and reach audiences in any language.",
    ...
    homeUseCase1Desc:
      "Turn one video into multiple languages with an AI video translator and subtitle editor.",
    homeUseCase2Title: "Language learners studying foreign content",
    homeUseCase2Desc:
      "Compare original and translated subtitles side by side for faster comprehension.",
    ...
    homeTestimonialsDesc: "111 upvotes on Product Hunt. Here's what users are saying.",
    homeViewOnProductHunt: "View on Product Hunt →",

    // Homepage - FAQ preview section
    homeFaqTitle: "Frequently asked questions",
    homeFaqDesc: "Quick answers to the most common questions about Translator.",
  ...
  ko: {
    ...
    pricingCostAnswer:
      "번역 크레딧은 동영상 길이와 언어 수에 따라 달라집니다. 대규모 팀 워크플로우는 문의해 주세요.",
    ...
    translateNeedSubtitlesDesc:
      "번역하기 전에 자막 편집기를 사용하여 자막을 가져오고, 정리하고, 동기화하세요.",
    translateGoToEditor: "자막 편집기로 이동 →",
    translateStartWithUrl: "비디오 URL로 시작하기",
    translateStartWithUrlDesc:
      "YouTube 동영상 및 기타 소스를 다운로드하여 바로 번역하세요.",
    ...
    videoDownloaderFeature3Desc:
      "편집, 번역, 내보내기에 최적화된 MP4 파일을 다운로드합니다.",
    ...
    videoDownloaderPlatformsDesc:
      "직접 URL 기반 다운로드를 허용하는 YouTube 및 기타 인기 플랫폼에서 다운로드하세요.",
    videoDownloaderPlatform1: "YouTube",
    videoDownloaderPlatform2: "기타 주요 플랫폼 (가용성은 다를 수 있음)",
    videoDownloaderQuality: "화질 옵션",
    videoDownloaderQualityDesc:
      "빠른 초안부터 고품질 내보내기까지, 워크플로우에 가장 적합한 해상도를 선택하세요.",
    ...
    faqQ4: "어떤 플랫폼을 지원하나요?",
    faqA4:
      "Translator는 macOS (Apple Silicon + Intel) 및 Windows에서 사용할 수 있습니다.",
    ...
    faqA10:
      "설정 또는 가격에 대한 도움이 필요하시면 문의 페이지를 방문하거나 이메일을 보내주세요.",
    ...
    aboutSubtitle:
      "Stage5 Tools는 현대 크리에이터, 교육자, 글로벌 팀을 위해 설계된 AI 기반 비디오 번역 및 자막 편집 앱인 Translator를 만듭니다.",
    aboutMission: "미션",
    aboutMissionDesc:
      "비디오 콘텐츠를 번역하고, 글로벌 미디어에서 배우고, 어떤 언어로든 시청자에게 다가가는 것을 쉽게 만듭니다.",
    aboutVision: "비전",
    aboutVisionDesc:
    ...
    contactSubtitle:
      "Translator에 대해 질문이 있으신가요? 설정, 가격, 파트너십, 기업 문의를 도와드립니다.",
    contactEmail: "이메일 문의",
    ...
    homeUseCase1Desc:
      "AI 비디오 번역기와 자막 편집기로 하나의 비디오를 여러 언어로 만드세요.",
    homeUseCase2Title: "외국 콘텐츠를 공부하는 언어 학습자",
    homeUseCase2Desc:
      "원본과 번역된 자막을 나란히 비교하여 더 빠르게 이해하세요.",
    ...
    homeTestimonialsDesc: "Product Hunt에서 111개의 업보트. 사용자들의 평가입니다.",
    homeViewOnProductHunt: "Product Hunt에서 보기 →",
