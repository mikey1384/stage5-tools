...
>> = {
  ...
  ja: {
    ...
    navAbout: "概要",
    navContact: "お問い合わせ",
    navOpenSource: "オープンソース",
    navDownload: "ダウンロード",
    footerProduct: "製品",
    footerEcho: "iPhone版Echo",
  ...
  vi: {
    ...
    navAbout: "Giới thiệu",
    navContact: "Liên hệ",
    navOpenSource: "Mã nguồn mở",
    navDownload: "Tải về",
    footerProduct: "Sản phẩm",
    footerEcho: "Echo cho iPhone",
