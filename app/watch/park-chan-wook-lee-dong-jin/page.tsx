          ...
          <div className="mx-auto max-w-4xl">
            ...
            <div className="mt-12 rounded-2xl border border-white/10 bg-white/[0.02] p-8">
              ...
              <p className="mt-3 text-base leading-7 text-gray-400">
                ...
                (Português). All three caption tracks are YouTube&apos;s
                automatic captions, translated using Translator. This is not a
                fresh transcription. The rest of the episode is not published
                here—this post explains the workflow so you can translate the
                full video yourself.
              </p>
              <p className="mt-3 text-base leading-7 text-gray-400">
