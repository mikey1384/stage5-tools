...
export const yooJiTaePiarchiaCopy: Record<SupportedLocale, WatchPageCopy> = {
  ...
  vi: { title: "Yoo Ji-tae | Translator", description: "Yoo Ji-tae nói về Oldboy và One Fine Spring Day", keywords: ["Yoo Ji-tae"], h1: "Yoo Ji-tae và Hai Bộ Phim Kinh Điển", intro: "Diễn viên Yoo Ji-tae thảo luận về One Fine Spring Day (Hur Jin-ho) và Oldboy (Park Chan-wook) với nhà phê bình Lee Dong-jin.", section1Title: "Giới thiệu", section1Body: ["Yoo Ji-tae đóng vai chính trong hai bộ phim quan trọng: One Fine Spring Day của Hur Jin-ho và Oldboy của Park Chan-wook."], howToTitle: "Cách xem với phụ đề", howToBody: "Translator là ứng dụng tải video và thêm phụ đề. Cách hoạt động:", howToSteps: [{title: "Dán URL", body: "Sao chép liên kết video."}, {title: "Tải xuống", body: "Translator tải xuống video."}, {title: "Phiên âm hoặc dịch", body: "Sử dụng AI để phiên âm hoặc dịch."}, {title: "Xem với phụ đề", body: "Chỉnh sửa và xuất phụ đề."}], pricingTitle: "Miễn phí gì", pricingFree: "Tải, chỉnh sửa, xuất.", pricingPaid: "AI yêu cầu tín dụng Stage5 hoặc API key.", section2Title: "Nội dung", section2Body: ["Translator cho quyền kiểm soát phụ đề."], downloadTitle: "Tải Translator", downloadBody: "Hoạt động trên macOS và Windows.", aboutTitle: "Về bài viết này", aboutBody: ["Video YouTube chính thức. 30 giây đầu có phụ đề."] }
};
