...
import { ferranAdriaWildProjectCopy } from "./copy";

const post = posts.find((p) => p.slug === "ferran-adria-wild-project")!;
...
export default async function FerranAdriaWildProjectPage({
  ...
  const structuredData = {
    ...
    headline: copy.h1,
    description: copy.description,
    url: `https://translator.tools${localizeHref("/watch/ferran-adria-wild-project")}`,
