...
import { ramsayHotOnesCopy } from "./copy";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildMetadata({
    ...
    path: "/watch/ramsay-hot-ones",
    keywords: copy.keywords,
    locale,
  });
}

export default async function RamsayHotOnesPage({
  searchParams,
}: {
  ...
  const structuredData = {
    ...
    headline: copy.h1,
    description: copy.description,
    url: `https://translator.tools${localizeHref("/watch/ramsay-hot-ones")}`,
    ...
    about: [
      {
        "@type": "Person",
        name: "Gordon Ramsay",
        description: "Celebrity chef and television personality",
      },
      {
        "@type": "Person",
        name: "Sean Evans",
      ...
      },
      {
        ...
        description:
          "Celebrity chef Gordon Ramsay takes on the Hot Ones challenge, eating spicy wings while answering questions",
